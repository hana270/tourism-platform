...
/**
 * Carrousel 3D "coverflow" — adapté de 21st.dev, recoloré à la charte IHOST
 * (encre chaude #1C1815 + accent orange brûlé var(--accent), au lieu du
 * thème doré d'origine). Volontairement le seul moment "spectaculaire"
 * sombre du site : tout le reste de la page reste blanc/sable.
 */
export function CoverFlowCarousel({
  ...
  return (
    <section
      ...
      style={{ backgroundColor: "#1c1815", color: "#ffffff", fontFamily: "var(--font-body, system-ui)" }}
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div
          ...
          style={{ background: "radial-gradient(circle at center, rgba(28,24,21,0.35) 0%, rgba(28,24,21,0.94) 100%)" }}
        />
      </div>
      ...
      <div className="relative w-full max-w-6xl mx-auto px-4 z-10 flex flex-col items-center">
        {sectionLabel && (
          <div className="flex items-center gap-3 mb-8">
            <span style={{ width: "36px", height: "1px", background: "linear-gradient(90deg, transparent, var(--accent))" }} />
            <h3
              style={{
                fontSize: "0.75rem",
                fontWeight: 700,
            ...
            <span style={{ width: "36px", height: "1px", background: "linear-gradient(90deg, var(--accent), transparent)" }} />
          </div>
        )}
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow: isCenter
                    ? "0 25px 60px rgba(0,0,0,0.9), 0 0 35px rgba(217,97,27,0.25)"
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "3px", marginTop: "auto", paddingBottom: "4px" }}>
                    ...
                    <div
                      style={{
                        width: "34px",
                        height: "2px",
                        backgroundColor: "var(--accent, #d9611b)",
                        borderRadius: "2px",
                        margin: "5px auto 4px",
                        boxShadow: "0 0 8px rgba(217,97,27,0.7)",
                      }}
                    />
                    ...
                    <a
                      ...
                      style={{
                        ...
                        padding: "7px 18px",
                        borderRadius: "9999px",
                        background: "linear-gradient(135deg, var(--accent, #d9611b) 0%, var(--accent-deep, #a8420c) 100%)",
                        color: "#ffffff",
                        fontSize: "0.72rem",
                        fontWeight: 800,
                        letterSpacing: "0.1em",
                        textTransform: "uppercase",
                        textDecoration: "none",
                        boxShadow: "0 4px 14px rgba(0,0,0,0.4), 0 0 15px rgba(217,97,27,0.35)",
                        cursor: "pointer",
                        transition: "transform 200ms ease, box-shadow 200ms ease",
                      }}
                    >
                      <span>{item.ctaText || "Découvrir"}</span>
                      <ArrowRightIcon />
                    </a>
                  </div>
                </div>
          ...
          {items.map((_, idx) => (
            <button
              ...
              style={{
                ...
                borderRadius: "9999px",
                backgroundColor: idx === currentIndex ? "var(--accent, #d9611b)" : "rgba(255,255,255,0.25)",
                border: "none",
                cursor: "pointer",
                boxShadow: idx === currentIndex ? "0 0 10px rgba(217,97,27,0.7)" : "none",
